...
def verify_claim_with_llm(
    claim: str, source_chunks: List[Dict], api_key: Optional[str] = None
) -> VerificationResult:
    """
                ...
                if len(parts) > 0 and "text" in parts[0]:
                    ...
                    try:
                        ...
                        return VerificationResult(
                            ...
                            verified=verified,
                            supporting_chunks=[
                                chunk["text"][:100] for chunk in source_chunks[:3]
                            ],
...
def batch_verify_claims(
    claims: List[str], chunks: List[Dict], max_workers: int = 3
