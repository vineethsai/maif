...
from ..agents.lifecycle_management import MAIFLifecycleState, MAIFMetrics
...
class MAIFAdaptationManager:
    ...
    def _register_default_handlers(self):
        """Register default action handlers."""
        from ..agents.lifecycle_management import MAIFSplitter, MAIFMerger
        ...
        def handle_transform(action: Action, context: Dict[str, Any]) -> bool:
            try:
                ...
                if transform_type == "version_upgrade":
                    from ..utils.version_management import VersionManager, SchemaRegistry
                    ...
                    from ..storage.columnar_storage import (
                        ColumnarFile,
                        ColumnType,
                        EncodingType,
                        CompressionType,
