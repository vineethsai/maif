...
class EnhancedSelfGoverningMAIF:
    ...
    def _register_action_handlers(self):
        ...
        self.rules_engine.register_action_handler(ActionType.REORGANIZE, handle_reorganize)
        ...
        self.rules_engine.register_action_handler(ActionType.TRANSFORM, handle_semantic_reorganize)
            ...
            for rule in triggered_rules:
                ...
                if result.success:
                    ...
                    self.history.append({
                        ...
                        "action": rule.actions[0].action_type.value if rule.actions else "unknown",
    ...
    def get_governance_report(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "active_rules": len(self.rules_engine.evaluate_rules({
