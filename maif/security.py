...
class MAIFSigner:
    ...
    def add_provenance_entry(
        ...
        """
        with self._lock:
            previous_entry = self.provenance_chain[-1] if self.provenance_chain else None
    ...
    @classmethod
    def from_private_key_hex(cls, private_key_hex: str, agent_id: Optional[str] = None) -> 'MAIFSigner':
        """
